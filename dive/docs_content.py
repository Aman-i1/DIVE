...
""",
            ...
            _card(
                "Google Colab",
                """
<p>No local setup. Open the ready-made notebook straight from GitHub:</p>
<p><a href="https://colab.research.google.com/github/Aman-i1/DIVE/blob/main/examples/colab_quickstart.ipynb"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"></a></p>
<p>It clones the repo, installs DIVE, and walks the whole flow: validate, train,
read the report, score new rows.</p>
<p>To start from a blank notebook instead, paste this into a cell:</p>
<pre><code>!git clone https://github.com/Aman-i1/DIVE.git
%cd DIVE
